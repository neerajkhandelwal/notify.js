...
$.fn.notify = function(){
	$(this).css({'display':'none','background-color':'#222','font-face':'Halvetica', 'font-size':'18x','font-weight':'bolder','color':'#FFF','position':'absolute','width':'auto','right':'30px','top':'50px','font-align':'center','padding':'15px','z-index':'1000','opacity':'.8','-moz-border-radius':'10px','-webkit-border-radius':'10px','text-shadow':'0px 1px 0px 1px'});
